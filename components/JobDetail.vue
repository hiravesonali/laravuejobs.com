        ...
        <div class="mt-5 md:mt-0 md:col-span-2 border-t-8 rounded-md border-green-300">
            <div class="shadow-md sm:rounded-t-md sm:overflow-hidden">
              ...
              <div class="px-4 bg-white sm:p-6 sm:pb-2">
                ...
                <div class="px-4 bg-white sm:p-6 sm:pb-2">
                  <h2 class="text-2xl font-bold text-gray-700">About Job</h2>
                <div class="grid gap-6">
                  <p class="text-md font-sm text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
              ...
              <div class="px-4 bg-white sm:p-6 sm:pb-2">
                  <h2 class="text-xl font-semibold text-gray-700">What you'll do:</h2>
                <div class="grid gap-6">
                  <p class="text-md font-sm text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
              ...
              <div class="px-4 bg-white sm:p-6 sm:pb-2">
                  <h2 class="text-xl font-semibold text-gray-700">What you bring:</h2>
                <div class="grid gap-6">
                  <p class="text-md font-sm text-gray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                    Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
                    Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
